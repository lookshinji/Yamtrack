...
urlpatterns = [
    ...
    path("import/anilist/private", views.import_anilist_private, name="import_anilist_private"),
    path("import/anilist/public", views.import_anilist_public, name="import_anilist_public"),
